...
<body class="h-full">
<div class="min-h-full" x-data="{ slideOver: false, alert: true }">
  <x-navbar></x-navbar>
  
  @if(session('success'))
  <div x-show="alert" id="successModal" tabindex="-1" aria-hidden="true" class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 bottom-0 z-50 flex justify-center items-center w-full h-full">
  ...
  <x-landingPage :productGiven="$products" />
