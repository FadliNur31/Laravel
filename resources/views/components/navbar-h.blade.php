...
<nav class="bg-gray-800" x-data="{ isOpen: false }" >
      ...
      <div class="flex h-16 items-center justify-between">
        ...
        <div class="-mr-2 flex md:hidden">
          ...
          <button type="button" @click="isOpen = !isOpen"
            ...
            <svg 
            :class="{'hidden': isOpen, 'block h-6 w-6': !isOpen }"
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        @can('admin')
              <a href="{{route('admin.index')}}" class=" block rounded-md bg-white px-3 py-2 text-sm font-medium text-black hover:bg-gray-700 hover:text-white" aria-current="page">Dashboard Admin</a>
        @endcan
      </div>
