...
<body x-data="{ open: true}" class="relative">
   ...
   id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform  " aria-label="Sidebar"  @click="open = !open">
